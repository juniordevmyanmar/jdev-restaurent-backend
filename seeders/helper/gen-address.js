const streetNames = ['Bogyoke Rd', 'Anawrahta Rd', 'Sule Pagoda Rd', 'Strand Rd', 'Mahabandoola Rd', 'Merchant Rd', 'Pansodan Rd', 'Maha Bandula Garden St', 'U Wisara Rd', 'Bo Aung Kyaw Rd'];
const townships = ['Bahan', 'Hlaing', 'Kamayut', 'Kyauktada', 'Lanmadaw', 'Latha', 'Mayangone', 'Pabedan', 'Sanchaung', 'Yankin'];
const cities = ['Yangon', 'Mandalay', 'Naypyidaw', 'Mawlamyine', 'Bago', 'Pathein', 'Monywa', 'Sittwe', 'Meiktila', 'Myitkyina'];
